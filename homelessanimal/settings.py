"""
Django settings for homelessanimal project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1','homelessanimal.onrender.com']
...
ROOT_URLCONF = 'homelessanimal.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],#add template path #BASE_DIR means the top of index
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'homelessanimal.wsgi.application'
